...
export declare type BackpackTFOptions<T1 extends IAPI, T2 extends IResponseHandler, T3 extends IParamConstructor> = {
    api: T1;
    responseHandler: T2;
    paramConstructor: T3;
};
export declare type BPTF<T1 extends IAPI, T2 extends IResponseHandler, T3 extends IParamConstructor> = BackpackTF<T1, T2, T3>;
export declare type DefaultBPTF = BPTF<API, typeof ResponseHandler, typeof ParamConstructor>;
